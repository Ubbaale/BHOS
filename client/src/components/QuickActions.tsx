...
const actions = [
  ...
  },
  {
    icon: UserCog,
    title: "Driver Portal",
    description: "Sign up as a driver or log in to view available rides, manage pickups, and track your earnings.",
    mobileDesc: "Sign up or log in as driver",
    link: "/driver/apply",
